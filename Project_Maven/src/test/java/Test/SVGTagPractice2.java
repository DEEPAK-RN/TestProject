...
public class SVGTagPractice2
{
	...
	public void testA() throws InterruptedException, AWTException, IOException
	{
		...
		System.out.println(circles.size()+" Elements present");
		int count = 0;
		int red = 0;
		int green = 0;
		...
		System.out.println(count+" Circles present");
		System.out.println(red+" Red circles present");
		System.out.println(green+" Green circles present");
		driver.quit();		
	}		
}